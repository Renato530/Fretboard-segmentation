...
def main(fileName):
    ...
    for i in range(len(guitar_images)):
        ...
        frets = FRETBOARD.frets_extraction(frets * rot_mask, kernel_lenght=10, niterations=4)

        # Fretboard edges extraction
        fretboard_edges = FRETBOARD.fretboardEdges(rot_HED, kernel_lenght=20, niterations=4)
        ...
        pts = FRETBOARD.mask_pts(fretboard_edges, peaks_frets, threshold=400, vmin=0, vmax=-1)
